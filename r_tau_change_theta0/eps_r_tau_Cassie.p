...
set output sprintf("%s",'r_tau_Cassie.eps')
...
set label "micro-Cassie-Baxter" at 5e-8,2e-8

set xrange [1e-8:3e-3]
set yrange [-1e-9:1e-4]

set label "(C)" at screen 0,0.97
set label "(i)" at screen 0.05,0.97
...
plot 	'data_num_40.dat'  u ($1):($2) w l lw 3 lc "web-green" title "{/Symbol q}_0=40{\260}",\
	'data_num_120.dat'  u ($1):($2) w l lw 3 lc "web-blue" title "{/Symbol q}_0=120{\260}"
